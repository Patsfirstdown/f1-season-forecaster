...
function driverCompareChart(driverA,driverB,nameA,nameB,raceName) {
    ...
    const fullNameA = predictionData.race_data[raceName][nameA]["driver_name"];
    const fullNameB = predictionData.race_data[raceName][nameB]["driver_name"];
