...
function updateUpdates() {
    ...
    const previousRaceName = predictionData.races[previousRace][1]
    const driverNames = Object.keys(
    ...
    for (racename of races) {
        ...
        if (Object.hasOwn(predictionData.wcc_data, racename)) {
            ...
            console.log("HI")
            console.log(oldtempWCC)
            console.log("HI")
            console.log(currentWCC)
            console.log("HI")
            if(!oldtempWCC) {
                //skip
            }
                ...
                //console.log(sortedWCC1)

                if(sortedWCC1[0][1].value>seasonWCC1big[2]) {
                    seasonWCC1big=[predictionData.races[racename][1],sortedWCC1[0][1].name,sortedWCC1[0][1].value]
                }
                if(sortedWCCAll[0][1].value>seasonWCCAllbig[2]) {
                    seasonWCCAllbig=[predictionData.races[racename][1],sortedWCCAll[0][1].name,sortedWCCAll[0][1].value]
                }
                if(sortedWCC1.at(-1)[1].value<seasonWCC1small[2]) {
                    seasonWCC1small=[predictionData.races[racename][1],sortedWCC1.at(-1)[1].name,sortedWCC1.at(-1)[1].value]
                }
                if(sortedWCCAll.at(-1)[1].value<seasonWCCAllsmall[2]) {
                    seasonWCCAllsmall=[predictionData.races[racename][1],sortedWCCAll.at(-1)[1].name,sortedWCCAll.at(-1)[1].value]
                }
            }
        }
        if (Object.hasOwn(predictionData.wdc_data, racename)) {
            ...
            if(!oldtempWDC) {
                ...
                if(sortedWDC1[0][1].value>seasonWDC1big[2]) {
                    seasonWDC1big=[predictionData.races[racename][1],sortedWDC1[0][1].name,sortedWDC1[0][1].value]
                };
                if(sortedWDCAll[0][1].value>seasonWDCAllbig[2]) {
                    seasonWDCAllbig=[predictionData.races[racename][1],sortedWDCAll[0][1].name,sortedWDCAll[0][1].value]
                };
                if(sortedWDC1.at(-1)[1].value<seasonWDC1small[2]) {
                    seasonWDC1small=[predictionData.races[racename][1],sortedWDC1.at(-1)[1].name,sortedWDC1.at(-1)[1].value]
                };
                if(sortedWDCAll.at(-1)[1].value<seasonWDCAllsmall[2]) {
                    seasonWDCAllsmall=[predictionData.races[racename][1],sortedWDCAll.at(-1)[1].name,sortedWDCAll.at(-1)[1].value]
                };
            }
        };
    ...
    document.getElementById("raceUpdates").innerHTML = `
        ...
        <div>
            <h3 style="text-align: center;">Post ${previousRaceName} Race Updates</h3>
        </div>
